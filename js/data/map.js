...
window.MAP_GRID = [
  ...
  ["墙壁", "boss", "传送阵", "商店", "战斗", "墙壁", "传送阵", "战斗", "战斗", "墙壁", "墙壁", "战斗", "墙壁", "墙壁", "墙壁", "墙壁"],
  ["墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "宝箱", "墙壁", "墙壁", "墙壁", "墙壁"],
  ["墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "战斗", "战斗", "战斗", "陷阱", "传送阵", "战斗", "墙壁", "墙壁", "墙壁", "墙壁"],
  ["墙壁", "宝箱", "战斗", "空地", "墙壁", "墙壁", "战斗", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁"],
  ["墙壁", "宝箱", "墙壁", "陷阱", "伏击", "陷阱", "战斗", "商店", "战斗", "战斗", "旧桥", "战斗", "开始", "营地", "墙壁", "墙壁"],
  ["墙壁", "宝箱", "战斗", "空地", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "强盗营地", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁"],
  ["墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁", "墙壁"],
]
...
window.TILE = {
  ...
  BRIDGE: 'bridge',       //派克的货单主线证据点：旧桥
  BANDIT_CAMP: 'bandit-camp', // 旧桥下方的强盗据点
}
...
const TILE_MAP = {
  ...
  '营地': TILE.CAMP,
  '旧桥': TILE.BRIDGE,
  '强盗营地': TILE.BANDIT_CAMP,
}

/* ---------- 传送阵注册表（每个都有名字） ---------- */
/* x/y 对应地图格；isCamp 表示城镇传送阵（始终激活，传送后进入营地） */
window.TELEPORTS = [
  { id: 'camp',   name: '雾灯镇传送阵', x: 13, y: 9, isCamp: true },
  { id: 'canyon', name: '翠谷传送阵',   x: 2,  y: 5 },
  { id: 'mist',   name: '迷雾林传送阵', x: 6,  y: 5 },
  { id: 'thorn',  name: '荆棘地传送阵', x: 10, y: 7 },
]
