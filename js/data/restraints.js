...
window.RESTRAINTS = [
  ...
  /* ============ 插入类妖缚装备（战斗格挡 + 接客加成，可自由穿脱） ============ */
  {
    ...
    desc: '2.5 cm · 菊穴装备：防护充能上限 1 点；每点抵挡 1 次菊穴攻击及其效果，需回城补充；插入类接客 +10G。',
    effect: 'insert_block',
  },
  {
    ...
    desc: '3.5 cm · 菊穴装备：防护充能上限 2 点；每点抵挡 1 次菊穴攻击及其效果，需回城补充；插入类接客 +15G。',
    effect: 'insert_block',
  },
  {
    ...
    desc: '4.2 cm · 菊穴装备：防护充能上限 3 点；每点抵挡 1 次菊穴攻击及其效果，需回城补充；插入类接客 +20G。',
    effect: 'insert_block',
  },
  {
    ...
    desc: '5.2 cm · 菊穴装备：防护充能上限 4 点；每点抵挡 1 次菊穴攻击及其效果，需回城补充；插入类接客 +30G。',
    effect: 'insert_block',
  },
  {
    ...
    desc: '2.8 cm · 女性专用小穴装备：每颗增加 1 点防护充能上限（最多 4 点），充能需回城补充；插入类接客 +10G。',
    effect: 'insert_block',
  },
  {
    ...
    desc: '3.8 cm · 女性专用小穴装备：防护充能上限 3 点；每点抵挡 1 次小穴攻击及其效果，需回城补充；插入类接客 +20G。',
    effect: 'insert_block',
  },
  {
    ...
    desc: '2.5 cm · 可插入菊穴或小穴：对应部位防护充能上限 1 点，需回城补充；插入类接客 +10G。',
    effect: 'insert_block',
  },
  {
    ...
    desc: '3.5 cm · 可插入菊穴或小穴：对应部位防护充能上限 2 点，需回城补充；插入类接客 +15G。',
    effect: 'insert_block',
  },
  {
    ...
    desc: '4.2 cm · 可插入菊穴或小穴：对应部位防护充能上限 3 点，需回城补充；插入类接客 +20G。',
    effect: 'insert_block',
  },
  {
    ...
    desc: '5.2 cm · 可插入菊穴或小穴：对应部位防护充能上限 4 点，需回城补充；插入类接客 +30G。',
    effect: 'insert_block',
  },
]
