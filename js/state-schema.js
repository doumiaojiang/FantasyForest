...
window.StateSchema = (function () {
  const DEFAULTS = {
    ...
    pStory: {
      ...
      mChapterStep: 0,
      mChapterBranch: null,
      mChapterAttitude: null,
      mWakeResist: 0,
      mSpankStack: 1,
      mWakeGearEscrow: null,
      mChapterFailures: 0,
      mChapterEscrow: null,
      mConfiscated: false,
      mConfiscationEscrow: null,
      mChapterRestraintEscrow: null,
      mGroomed: false,
      mBranded: false,
      mSisterBond: false,
      mMarketResponse: null,
      mDayaChoice: null,
  ...
  const LEGACY_FIELDS = {
    ...
    _pMChapterStage: ['pStory', 'mChapterStage'],
    _pMChapterStep: ['pStory', 'mChapterStep'],
    _pMChapterBranch: ['pStory', 'mChapterBranch'],
    ...
    _pMConfiscated: ['pStory', 'mConfiscated'],
    _pMConfiscationEscrow: ['pStory', 'mConfiscationEscrow'],
    _pMChapterRestraintEscrow: ['pStory', 'mChapterRestraintEscrow'],
    _pMGroomed: ['pStory', 'mGroomed'],
    _pMBranded: ['pStory', 'mBranded'],
    _pMSisterBond: ['pStory', 'mSisterBond'],
