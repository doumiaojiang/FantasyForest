...
window.Dialog = (function () {
  ...
  function shop (tile, stock) {
    ...
    // 消耗品（插入用品已全部迁入 DD 装备定义，不再出现在普通商店数据中）
    if (!isBlacksmith) {
  ...
  function showRules () {
    const rules = [
      ...
      { title: '🛡️ 战斗操作', text: '🛡️ <b>防御</b>：本回合所受伤害减半（仅一次）。<br>🏳️ <b>投降</b>：二选一——上贡金币（付钱走人）或接受羞辱任务（承受惩罚后离开）。<br>🧪 <b>物品</b>：每回合可使用 1 个。<br>🍑 <b>插入类妖缚装备</b>：菊穴与小穴各有一个槽位。小/中/大/巨肛塞每场分别抵挡 1/2/3/4 次菊穴攻击及其效果；普通假阳具分小/中/大/巨型四种尺寸，可任选菊穴或小穴；跳蛋按颗塞入（最多 4 颗），每颗抵挡 1 次小穴攻击；震动棒抵挡 3 次。贞操装置会封住小穴槽。<br>🪞 <b>屏障咒</b>：反射一半伤害给敌人，持续 2 回合。' },
      ...
      { title: '💀 死亡与存档', text: '死亡后在最近经过的传送阵重生，金币减半。<br>如果没有传送阵则回到起点。<br>传送阵、新游戏、Boss 战前会自动存档；顶栏可随时手动存档。' },
    ]
