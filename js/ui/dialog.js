...
window.Dialog = (function () {
  ...
  function showRules () {
    const rules = [
      ...
      { title: '🛡️ 战斗操作', text: '🛡️ <b>防御</b>：本回合所受伤害减半（仅一次）。<br>🏳️ <b>投降</b>：二选一——上贡金币（付钱走人）或接受羞辱任务（承受惩罚后离开）。<br>🧪 <b>物品</b>：每回合可使用 1 个。<br>🍑 <b>插入类妖缚装备</b>：菊穴与小穴各有一个槽位。小/中/大/巨肛塞每场分别抵挡 1/2/3/4 次菊穴攻击及其效果；跳蛋按颗塞入（最多 4 颗），每颗抵挡 1 次小穴攻击；震动棒抵挡 3 次；双用假阳具可任选一个部位。贞操装置会封住小穴槽。<br>🪞 <b>屏障咒</b>：反射一半伤害给敌人，持续 2 回合。' },
