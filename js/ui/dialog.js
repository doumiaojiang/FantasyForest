...
window.Dialog = (function () {
  ...
  function showRules () {
    const rules = [
      ...
      { title: '🛡️ 战斗操作', text: '🛡️ <b>防御</b>：本回合所受伤害减半（仅一次）。<br>🏳️ <b>投降</b>：二选一——上贡金币（付钱走人）或接受羞辱任务（承受惩罚后离开）。<br>🧪 <b>物品</b>：每回合可使用 1 个。<br>🍑 <b>肛塞</b>：菊穴只能塞一个。小肛塞挡 1 次破损；巨肛塞挡 3 次、可随时取下（取下/用尽还回背包）。<br>🪞 <b>屏障咒</b>：反射一半伤害给敌人，持续 2 回合。' },
